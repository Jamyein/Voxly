...
class RealScanRepository @Inject constructor(
    ...
    override fun requestRefresh(forceRefresh: Boolean) {
    ...
    // Data flows delegate to the scanner (which delegates to aggregator / cache)
    override val allAudios: StateFlow<List<AudioFile>> = audioFileScanner.filteredFiles
